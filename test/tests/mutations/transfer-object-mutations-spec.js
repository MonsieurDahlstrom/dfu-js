...
//Code to test
import TransferObjectMutations from '../../../src/mutations/transfer-object-mutations'
...
describe('TransferObject mutations', function () {
  ...
  describe('#ADD_TRANSFER_OBJECT', function () {
    it('transferObject added to queue', function () {
      TransferObjectMutations[MutationTypes.ADD_TRANSFER_OBJECT](state,transferObject)
  ...
  describe('#UPDATE_TRANSFER_OBJECT', function () {
    it('transferObject added to queue', function () {
      state.objects.push(transferObject)
      TransferObjectMutations[MutationTypes.UPDATE_TRANSFER_OBJECT](state,transferObject)
      expect(state.objects.length).to.equal(1)
    })
  })
  ...
  describe('#REMOVE_TRANSFER_OBJECT', function () {
    it('transferObject added to queue', function () {
      state.objects.push(transferObject)
      TransferObjectMutations[MutationTypes.REMOVE_TRANSFER_OBJECT](state,transferObject)
